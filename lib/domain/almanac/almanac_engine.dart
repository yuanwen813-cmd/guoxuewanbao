...
class AlmanacDay {
  ...
  const AlmanacDay({
    ...
    this.lunarDate = '农历信息暂未启用',
    this.lunarData,
    this.yearGanzhi = '暂未启用',
    this.monthGanzhi = '暂未启用',
    this.dayGanzhi = '暂未启用',
    this.zodiac = '',
    this.zodiacData,
    this.solarTerm = '',
    ...
    this.source = 'local_rule_beta',
    this.dataQuality = 'beta',
  });
...
class AlmanacEngine {
  ...
  List<String> _pickFromPool(
      String dateKey, int index, List<String> pool, int count) {
