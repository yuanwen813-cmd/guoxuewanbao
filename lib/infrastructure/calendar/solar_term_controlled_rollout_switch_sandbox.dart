...
class SolarTermControlledRolloutSwitchSandboxStateTransition {
  ...
  final bool allowed;
  final String reason;
  const SolarTermControlledRolloutSwitchSandboxStateTransition(
      {required this.from,
      required this.to,
      this.allowed = false,
      this.reason = ''});
  Map<String, dynamic> toJson() =>
      {'from': from, 'to': to, 'allowed': allowed, 'reason': reason};
}
...
class SolarTermControlledRolloutSwitchSandboxGateCheck {
  ...
  final String note;
  const SolarTermControlledRolloutSwitchSandboxGateCheck(
      {required this.id,
      this.passed = false,
      this.required = true,
...
class SolarTermControlledRolloutSwitchSandboxKillSwitchResult {
  ...
  final bool forcedLockedOff;
  final bool calendarProviderDisabled;
  final bool pageDisplayDisabled;
  final bool shareExposureDisabled;
  final bool snapshotWriteDisabled;
  final bool ganzhiDependencyDisabled;
  final bool clashDependencyDisabled;
  ...
  const SolarTermControlledRolloutSwitchSandboxKillSwitchResult({
    ...
    this.previousState = '',
    this.finalState = '',
    this.forcedLockedOff = true,
    this.calendarProviderDisabled = true,
    this.pageDisplayDisabled = true,
    this.shareExposureDisabled = true,
    this.snapshotWriteDisabled = true,
    this.ganzhiDependencyDisabled = true,
    this.clashDependencyDisabled = true,
  ...
  Map<String, dynamic> toJson() => {
        ...
        'pageDisplayDisabled': pageDisplayDisabled,
        'shareExposureDisabled': shareExposureDisabled,
        'snapshotWriteDisabled': snapshotWriteDisabled,
        'ganzhiDependencyDisabled': ganzhiDependencyDisabled,
        'clashDependencyDisabled': clashDependencyDisabled,
...
class SolarTermControlledRolloutSwitchSandboxRollbackResult {
  ...
  final bool restoredUnavailableState;
  final bool calendarProviderStillUnavailable;
  final bool pageDisplayStillHidden;
  final bool shareStillHidden;
  final bool snapshotStillClean;
  final bool ganzhiStillUnavailable;
  final bool clashStillUnavailable;
  final bool lunarPreserved;
  final bool zodiacPreserved;

  const SolarTermControlledRolloutSwitchSandboxRollbackResult()
      : rollbackExecuted = true,
        restoredUnavailableState = true,
        calendarProviderStillUnavailable = true,
        pageDisplayStillHidden = true,
        shareStillHidden = true,
        snapshotStillClean = true,
        ganzhiStillUnavailable = true,
        clashStillUnavailable = true,
        lunarPreserved = true,
        zodiacPreserved = true;

  Map<String, dynamic> toJson() => {
        'rollbackExecuted': rollbackExecuted,
        'restoredUnavailableState': restoredUnavailableState,
        'calendarProviderStillUnavailable': calendarProviderStillUnavailable,
        'pageDisplayStillHidden': pageDisplayStillHidden,
        'shareStillHidden': shareStillHidden,
        'snapshotStillClean': snapshotStillClean,
        'ganzhiStillUnavailable': ganzhiStillUnavailable,
        'clashStillUnavailable': clashStillUnavailable,
        'lunarPreserved': lunarPreserved,
        'zodiacPreserved': zodiacPreserved,
      };
}
...
class SolarTermControlledRolloutSwitchSandboxGuard {
  ...
  bool get allSafe =>
      !productionReady &&
      !publicExposure &&
      !calendarProviderIntegration &&
      !displayAllowed &&
      !shareAllowed &&
      !snapshotAllowed &&
      !ganzhiDependencyAllowed &&
      !clashDependencyAllowed;
...
class SolarTermControlledRolloutSwitchSandboxResult {
  ...
  final String initialSwitchState;
  final String targetSwitchState;
  final String finalSwitchState;
  final List<SolarTermControlledRolloutSwitchSandboxStateTransition>
      stateTransitions;
  final List<SolarTermControlledRolloutSwitchSandboxGateCheck> gateChecks;
  final SolarTermControlledRolloutSwitchSandboxKillSwitchResult
      killSwitchResult;
  ...
  const SolarTermControlledRolloutSwitchSandboxResult({
    ...
    required this.targetSwitchState,
    required this.finalSwitchState,
    required this.stateTransitions,
    required this.gateChecks,
    required this.killSwitchResult,
...
class SolarTermControlledRolloutSwitchSandbox {
  ...
  SolarTermControlledRolloutSwitchSandboxResult validate({
    ...
    // State transitions
    final transitions =
        <SolarTermControlledRolloutSwitchSandboxStateTransition>[];
    ...
    transitions.add(SolarTermControlledRolloutSwitchSandboxStateTransition(
      from: initialSwitchState,
      to: targetSwitchState,
      allowed: isAllowed,
      reason:
          isAllowed ? '' : '从 $initialSwitchState 不支持直接转到 $targetSwitchState',
    ));

    // Gate checks
    final gateChecks = <SolarTermControlledRolloutSwitchSandboxGateCheck>[
      SolarTermControlledRolloutSwitchSandboxGateCheck(
          id: 'reviewFrozenConfirmed',
          passed: switchDesignStatus == 'switch_design_ready',
          note: switchDesignStatus),
      SolarTermControlledRolloutSwitchSandboxGateCheck(
          id: 'humanApprovalConfirmed', passed: false, note: '需人工批准'),
      SolarTermControlledRolloutSwitchSandboxGateCheck(
          id: 'noGoRulesClear', passed: allGatesPassed, severity: 'high'),
      SolarTermControlledRolloutSwitchSandboxGateCheck(
          id: 'noHighRisk', passed: !hasHighRisk, severity: 'high'),
      SolarTermControlledRolloutSwitchSandboxGateCheck(
          id: 'rollbackPlanReady', passed: rollbackSuccessful),
      SolarTermControlledRolloutSwitchSandboxGateCheck(
          id: 'killSwitchReady', passed: true),
      SolarTermControlledRolloutSwitchSandboxGateCheck(
          id: 'calendarProviderGuardReady',
          passed: !guard.calendarProviderIntegration),
      SolarTermControlledRolloutSwitchSandboxGateCheck(
          id: 'pageDisplayGuardReady', passed: !guard.displayAllowed),
      SolarTermControlledRolloutSwitchSandboxGateCheck(
          id: 'shareExposureGuardReady', passed: !guard.shareAllowed),
      SolarTermControlledRolloutSwitchSandboxGateCheck(
          id: 'snapshotWriteGuardReady', passed: !guard.snapshotAllowed),
      SolarTermControlledRolloutSwitchSandboxGateCheck(
          id: 'ganzhiDependencyGuardReady',
          passed: !guard.ganzhiDependencyAllowed),
      SolarTermControlledRolloutSwitchSandboxGateCheck(
          id: 'clashDependencyGuardReady',
          passed: !guard.clashDependencyAllowed),
      SolarTermControlledRolloutSwitchSandboxGateCheck(
          id: 'monitoringPlanReady', passed: false, note: '需监控计划'),
      SolarTermControlledRolloutSwitchSandboxGateCheck(
          id: 'rollbackDrillRequired', passed: false, severity: 'high'),
      SolarTermControlledRolloutSwitchSandboxGateCheck(
          id: 'finalReleaseApprovalRequired', passed: false),
    ];
    ...
    if (!guard.allSafe) {
      status = 'blocked';
      finalState = 'locked_off';
      blockers.add('guard_unsafe');
    } else if (switchDesignStatus == 'blocked') {
      status = 'blocked';
      finalState = initialSwitchState;
      blockers.add('design_blocked');
    } else if (switchDesignStatus == 'design_not_allowed') {
      status = 'sandbox_not_allowed';
      finalState = initialSwitchState;
    } else if (hasHighRisk) {
      status = 'blocked';
      finalState = 'locked_off';
      blockers.add('high_risk');
    } else if (killSwitchTriggered) {
      status = 'killed_and_locked_off';
      finalState = 'locked_off';
      ...
      status = 'sandbox_failed';
      finalState = initialSwitchState;
      blockers.add('required_gate_failed');
    } else if (!isAllowed) {
      status = 'sandbox_failed';
      finalState = initialSwitchState;
      blockers.add('invalid_transition');
    } else if (switchDesignStatus == 'switch_design_ready') {
      status = 'sandbox_passed';
      finalState = targetSwitchState;
    } else {
      status = 'blocked';
      finalState = 'locked_off';
    }
    ...
    final killResult = SolarTermControlledRolloutSwitchSandboxKillSwitchResult(
      ...
      previousState: initialSwitchState,
      finalState: finalState,
    );

    return SolarTermControlledRolloutSwitchSandboxResult(
      sampleName: sampleName,
      dateRange: dateRange.isEmpty ? 'v0.22-v0.43' : dateRange,
      sandboxStatus: status,
      initialSwitchState: initialSwitchState,
      targetSwitchState: targetSwitchState,
      finalSwitchState: finalState,
  ...
  Map<String, dynamic> buildDebugJson() => {
        ...
        'riskList': [],
        'guardFlags':
            const SolarTermControlledRolloutSwitchSandboxGuard().toJson(),
        'conclusionNote':
            'controlled switch sandbox only, not public solar term capability',
      };
}
