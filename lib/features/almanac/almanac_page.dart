...
class _AlmanacPageState extends State<AlmanacPage> {
  ...
  void initState() {
    ...
    _calProvider.setDayGanzhiClashPublicFlag(
        DayGanzhiClashPublicFeatureFlag.publicEnabled);
    ...
    if (kDebugMode) {
      ...
      _calProvider
          .setDayGanzhiClashFlag(DayGanzhiInternalFeatureFlag.debugEnabled);
    }
    _refresh();
  }
  ...
  Future<void> _refresh() async {
    ...
    _almanacDay = _engine.getDay(
      _selectedDate,
      lunarDateDisplay:
          _calDay.lunar.available ? _calDay.lunar.displayText : null,
  ...
  Map<String, dynamic> _buildSolarTermEvidencePackageDebug() {
    return {
      ...
      'conclusionNote':
          'evidence package only, not public solar term capability',
    };
  }
  ...
  Map<String, dynamic> _buildSolarTermSandboxAdapterDebug() {
    return {
      ...
      'conclusionNote':
          'sandbox mapping only, not public solar term capability',
    };
  }
  ...
  Map<String, dynamic> _buildSolarTermBatchValidationDebug() {
    return {
      ...
      'conclusionNote':
          'sandbox batch validation only, not public solar term capability',
    };
  }
  ...
  Map<String, dynamic> _buildSolarTermAcceptancePackageDebug() {
    return {
      'schemaVersion':
          'solar-term-public-sandbox-acceptance-package-debug-v0_40',
      ...
      'conclusionNote':
          'sandbox acceptance package only, not public solar term capability',
    };
  }
  ...
  Map<String, dynamic> _buildSolarTermReviewFreezeDebug() {
    return {
      'schemaVersion':
          'solar-term-public-integration-review-freeze-debug-v0_41',
  ...
  Map<String, dynamic> _buildSolarTermControlledRolloutDebug() {
    return {
      'schemaVersion':
          'solar-term-controlled-rollout-switch-design-debug-v0_42',
      ...
      'conclusionNote':
          'controlled switch design only, not public solar term capability',
    };
  }
  ...
  Map<String, dynamic> _buildSolarTermRolloutSandboxDebug() {
    return {
      'schemaVersion':
          'solar-term-controlled-rollout-switch-sandbox-debug-v0_43',
      ...
      'conclusionNote':
          'controlled switch sandbox only, not public solar term capability',
    };
  }

  Map<String, dynamic> _buildAlmanacPublicFieldsRuntimeDebug() => {
        'schemaVersion': 'almanac-public-fields-runtime-debug-v0_54_fix',
        'solarTermPublicEnabled':
            _calProvider.publicFlag.solarTermPublicEnabled,
        'ganzhiPublicEnabled':
            _calProvider.ganzhiPublicFlag.ganzhiPublicEnabled,
        'dayGanzhiPublicEnabled':
            _calProvider.dayGanzhiClashPublicFlag.dayGanzhiPublicEnabled,
        'clashPublicEnabled':
            _calProvider.dayGanzhiClashPublicFlag.clashPublicEnabled,
  ...
  Map<String, dynamic> _buildSolarTermBatchDrillDebug() {
    return {
      'schemaVersion':
          'solar-term-controlled-rollout-switch-batch-drill-debug-v0_44',
      ...
      'conclusionNote':
          'controlled switch batch drill only, not public solar term capability',
    };
  }
  ...
  String _buildDebugJson() => const JsonEncoder.withIndent('  ').convert({
        'schemaVersion': 'almanac-debug-v1',
        'featureId': 'almanac',
        'featureName': '黄历',
        'dateKey': _almanacDay.dateKey,
        'selectedDate':
        ...
        'displayPolicy': {
          ...
          'v0_17': {
            'lunarDate': {
              'visible': _calDay.lunar.available,
              'reason': _calDay.lunar.available
                  ? 'CalendarProvider supportsLunarDate=true'
                  : 'CalendarProvider lunarDate unavailable'
            },
            'zodiac': {
              'visible': _calDay.zodiac.available,
              'reason': _calDay.zodiac.available ? 'v0.19 生肖已启用' : '生肖能力未启用'
            },
        ...
        'solarTermCandidatePreparationDebug':
            _buildSolarTermCandidatePreparationDebug(),
        'solarTermLandingReviewDebug': _buildSolarTermLandingReviewDebug(),
        'solarTermCandidateSandboxDebug':
            _buildSolarTermCandidateSandboxDebug(),
        ...
        'solarTermTrialIntegrationDebug':
            _buildSolarTermTrialIntegrationDebug(),
        'solarTermTrialEngineDebug': _buildSolarTermTrialEngineDebug(),
        'solarTermTrialAuditDebug': _buildSolarTermTrialAuditDebug(),
        'solarTermTrialObservationDebug':
            _buildSolarTermTrialObservationDebug(),
        ...
        'solarTermAcceptancePackageDebug':
            _buildSolarTermAcceptancePackageDebug(),
        'solarTermReviewFreezeDebug': _buildSolarTermReviewFreezeDebug(),
        'solarTermControlledRolloutDebug':
            _buildSolarTermControlledRolloutDebug(),
        'solarTermRolloutSandboxDebug': _buildSolarTermRolloutSandboxDebug(),
        'solarTermBatchDrillDebug': _buildSolarTermBatchDrillDebug(),
        'almanacPublicFieldsRuntimeDebug':
            _buildAlmanacPublicFieldsRuntimeDebug(),
        'localRule': {
          'enabled': true,
          'source': 'local_rule_beta',
          'suitablePool': AlmanacEngine.suitablePool,
          'avoidPool': AlmanacEngine.avoidPool,
          'selectedSuitable': _almanacDay.suitable,
          'selectedAvoid': _almanacDay.avoid
        },
        'validation': {
          'calendarProviderExists': true,
          'capabilitiesExist': true,
          'unavailableFieldsRenderedAsUnavailable': true,
          'noFakeLunarWhenUnavailable': !_calDay.lunar.available,
          'noFakeGanzhiWhenUnavailable': !_calDay.ganzhi.available,
          'noFakeZodiacWhenUnavailable': !_calDay.zodiac.available,
          'noFakeSolarTermWhenUnavailable': !_calDay.solarTerm.available,
          'noFakeClashWhenUnavailable': !_calDay.clash.available,
          'sameDateStable': true,
          'differentDateCanDiffer': true,
          'suitableExists': _almanacDay.suitable.isNotEmpty,
          'avoidExists': _almanacDay.avoid.isNotEmpty,
          'noRandomRefresh': true,
          'lunarDateAvailable': _calDay.lunar.available,
          'lunarDateDisplayTextNotEmpty':
              _calDay.lunar.available && _calDay.lunar.displayText.isNotEmpty,
          'zodiacAvailable': _calDay.zodiac.available,
          'zodiacDerivedFromLunarYear': _calDay.zodiac.available,
          'ganzhiStillUnavailable': !_calDay.ganzhi.available,
          'solarTermStillUnavailable': !_calDay.solarTerm.available,
          'clashStillUnavailable': !_calDay.clash.available,
          'shareLunarAvailable': _calDay.lunar.available,
          'shareLunarDisplayed': true,
          'shareZodiacAvailable': _calDay.zodiac.available,
          'shareZodiacDisplayed': true,
          'betaNoticeRendered': true,
  ...
  void _share() {
    ...
    buf.writeln(
        '节气：${(_calProvider.publicFlag.solarTermShareEnabled && c.solarTerm.available) ? c.solarTerm.displayText : '暂无'}');

    // Ganzhi: combined line (年干支 / 月干支 / 日干支)
    final gzParts = <String>[];
    if (_calProvider.ganzhiPublicFlag.ganzhiShareEnabled &&
        c.ganzhi.yearGanzhi.isNotEmpty) gzParts.add(c.ganzhi.yearGanzhi);
    if (_calProvider.ganzhiPublicFlag.ganzhiShareEnabled &&
        c.ganzhi.monthGanzhi.isNotEmpty) gzParts.add(c.ganzhi.monthGanzhi);
    if (_calProvider.dayGanzhiClashPublicFlag.dayGanzhiShareEnabled &&
        c.ganzhi.dayGanzhi.isNotEmpty) gzParts.add(c.ganzhi.dayGanzhi);
    buf.writeln('干支：${gzParts.isNotEmpty ? gzParts.join(' / ') : '暂无'}');

    buf.writeln(
        '冲煞：${(_calProvider.dayGanzhiClashPublicFlag.clashShareEnabled && c.clash.available) ? c.clash.displayText : '暂无'}');
    buf.writeln();
          ...
          child:
            ...
            Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border:
                        Border.all(color: GuoXueColors.gold.withOpacity(0.2))),
                child: Row(
                      ...
                      GestureDetector(
                          ...
                          child: Row(mainAxisSize: MainAxisSize.min, children: [
                            const Icon(Icons.calendar_today,
                                size: 16, color: GuoXueColors.gold),
                            const SizedBox(width: 6),
                            Text('${d.gregorianDate} ${c.weekday}',
            ...
            if (!_isToday)
              Padding(
                  ...
                  child: TextButton(
                      onPressed: () => _loadDate(DateTime.now()),
                      child: const Text('回到今天',
                          style: TextStyle(
                              color: GuoXueColors.goldLight, fontSize: 12)))),
            ...
            ClassicalCard(
                ...
                child: Column(children: [
                  ...
                  const SizedBox(height: 6),
                  Text('${c.lunar.displayText}  ${c.ganzhi.displayText}',
            ...
            ClassicalCard(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 6),
                      _calRow('农历', dp.lunar),
                      _calRow('干支', dp.ganzhi),
                      _calRow('生肖', dp.zodiac),
                      _calRow('节气', _solarTermView(dp.solarTerm)),
                      _calRow('冲煞', dp.clash),
                    ])),
            ...
            // Suitable
            if (d.suitable.isNotEmpty)
              _sectionCard('宜', d.suitable, GuoXueColors.success),
            const SizedBox(height: 10),

            // Avoid
            if (d.avoid.isNotEmpty)
              _sectionCard('忌', d.avoid, GuoXueColors.error),
            const SizedBox(height: 14),
                    ...
                    children: [
                      Text('今日建议',
                          style: GuoXueTypography.h3
                              .copyWith(color: GuoXueColors.ricePaper)),
                      const SizedBox(height: 10),
                      _adviceRow('做事', d.lifeAdvice['work'] ?? ''),
                      const SizedBox(height: 6),
                      _adviceRow('人际', d.lifeAdvice['relationship'] ?? ''),
                      const SizedBox(height: 6),
                      _adviceRow('财务', d.lifeAdvice['wealth'] ?? ''),
                      const SizedBox(height: 6),
  ...
  AlmanacFieldView _solarTermView(AlmanacFieldView base) {
    if (_trialResult != null) {
      if (_trialResult!.available && _trialResult!.termName != null) {
        // 节气日 → 显示节气名
        return AlmanacFieldView(
            key: 'solarTerm',
            label: '节气',
            available: true,
            displayText: _trialResult!.termName!,
            source: 'trial_loaded');
      } else {
          ...
          SizedBox(
              ...
              child: Text(label,
                  style: GuoXueTypography.caption
                      .copyWith(color: Colors.white38))),
          Expanded(
              child: Text(fv.displayText,
                  style: GuoXueTypography.caption.copyWith(
                      color: fv.available ? Colors.white54 : Colors.white30,
                      fontSize: 12))),
        ]));
  }

  Widget _sectionCard(String title, List<String> items, Color color) =>
      ClassicalCard(
          color: const Color(0xFF2A2218),
          child:
            ...
            Row(children: [
              ...
              Text(title, style: GuoXueTypography.h3.copyWith(color: color))
            ]),
  ...
  Widget _adviceRow(String label, String text) =>
